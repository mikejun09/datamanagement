    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <!-- Delete Form -->
                    <form action="{{ route('user_deleteCoordinator', $coordinator->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this coordinator?')">
                        @csrf
                        @method('DELETE')
...
<div class="mt-5 col-md-12">
    <form method="GET" action="{{ route('user_voters') }}">
